...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-250,5.85683,250,6.590763);
   pad1->SetFillColor(0);
   ...
   hdata_phip->SetBinContent(50,1704456);
   hdata_phip->SetBinContent(51,1735766);
   hdata_phip->SetEntries(3440222);
   ...
   hmc_phip->SetBinContent(50,1743229);
   hmc_phip->SetBinContent(51,1696993);
   hmc_phip->SetEntries(395613);
...
// ------------>Primitives in pad: pad2
   ...
   hist_ratio4->SetBinContent(50,-2.224213);
   hist_ratio4->SetBinContent(51,2.284814);
   hist_ratio4->SetBinError(50,0.1864913);
   hist_ratio4->SetBinError(51,0.5014814);
