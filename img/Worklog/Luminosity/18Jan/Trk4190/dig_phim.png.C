...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-250,6.949942,250,7.678289);
   pad1->SetFillColor(0);
   ...
   hdata_phim->SetBinContent(50,2.127213e+07);
   hdata_phim->SetBinContent(51,2.10815e+07);
   hdata_phim->SetEntries(4.235363e+07);
   ...
   hmc_phim->SetBinContent(50,2.101609e+07);
   hmc_phim->SetBinContent(51,2.133754e+07);
   hmc_phim->SetEntries(992154);
...
// ------------>Primitives in pad: pad2
   ...
   hist_ratio5->SetBinContent(50,1.218276);
   hist_ratio5->SetBinContent(51,-1.199923);
   hist_ratio5->SetBinError(50,0.09648432);
   hist_ratio5->SetBinError(51,0.008682253);
