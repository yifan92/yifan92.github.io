...
// ------------>Primitives in pad: pad1
   ...
   hmc_phim->SetBinContent(50,2.09965e+07);
   hmc_phim->SetBinContent(51,2.135714e+07);
   hmc_phim->SetEntries(401999);
...
// ------------>Primitives in pad: pad2
   ...
   hist_ratio5->SetBinContent(50,1.312747);
   hist_ratio5->SetBinContent(51,-1.29058);
   hist_ratio5->SetBinError(50,0.1006169);
   hist_ratio5->SetBinError(51,0.01261645);
