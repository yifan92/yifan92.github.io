...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-250,6.949206,250,7.679019);
   pad1->SetFillColor(0);
   ...
   hdata_phip->SetBinContent(50,2.10529e+07);
   hdata_phip->SetBinContent(51,2.130073e+07);
   hdata_phip->SetEntries(4.235363e+07);
   ...
   hmc_phip->SetBinContent(50,2.142393e+07);
   hmc_phip->SetBinContent(51,2.09297e+07);
   hmc_phip->SetEntries(401999);
...
// ------------>Primitives in pad: pad2
   ...
   hist_ratio4->SetBinContent(50,-1.731861);
   hist_ratio4->SetBinContent(51,1.772757);
   hist_ratio4->SetBinError(50,0.03176214);
   hist_ratio4->SetBinError(51,0.1206859);
