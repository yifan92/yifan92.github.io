...
//=========  (Tue Jan 16 10:35:20 2018) by ROOT version5.34/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-250,5.218407,250,5.944467);
   pad1->SetFillColor(0);
   ...
   hdata_phim->SetBinContent(50,391505);
   hdata_phim->SetBinContent(51,392301);
   hdata_phim->SetEntries(783806);
   ...
   hmc_phim->SetBinContent(50,388928.6);
   hmc_phim->SetBinContent(51,394877.4);
...
// ------------>Primitives in pad: pad2
   ...
   hist_ratio5->SetBinContent(50,0.6624265);
   hist_ratio5->SetBinContent(51,-0.6524472);
   hist_ratio5->SetBinError(50,0.5322568);
   hist_ratio5->SetBinError(51,0.1107977);
